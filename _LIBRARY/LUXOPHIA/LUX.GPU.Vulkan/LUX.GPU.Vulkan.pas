...
begin
     ...
     set_image_layout( Vulkan_, Vulkan_.Instans[0].Devices[0].Swapchs[0].Framers.Viewer.Image, Ord( VK_IMAGE_ASPECT_COLOR_BIT ), VK_IMAGE_LAYOUT_PRESENT_SRC_KHR,
     ...
     vkCmdCopyImage( Vulkan_.Instans[0].Devices[0].Poolers[0].Commans[0].Handle, Vulkan_.Instans[0].Devices[0].Swapchs[0].Framers.Viewer.Image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, mappableImage,
