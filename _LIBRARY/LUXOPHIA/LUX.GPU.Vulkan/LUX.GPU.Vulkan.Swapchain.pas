...
begin
     ...
     Assert( vkGetPhysicalDeviceSurfaceCapabilitiesKHR( TVkDevice( _Device ).Physic, TVkDevice( _Device ).Devices.Instan.Surfacs[0].Handle, @surfCapabilities ) = VK_SUCCESS );

     Assert( vkGetPhysicalDeviceSurfacePresentModesKHR( TVkDevice( _Device ).Physic, TVkDevice( _Device ).Devices.Instan.Surfacs[0].Handle, @presentModeCount, nil ) = VK_SUCCESS );

     Assert( presentModeCount > 0 );

     SetLength( presentModes, presentModeCount );

     Assert( vkGetPhysicalDeviceSurfacePresentModesKHR( TVkDevice( _Device ).Physic, TVkDevice( _Device ).Devices.Instan.Surfacs[0].Handle, @presentModeCount, @presentModes[0] ) = VK_SUCCESS );
     ...
     begin
          ...
          swapchainExtent.width  := TVkDevice( _Device ).Devices.Instan.Surfacs[0].PxSizeX;
          swapchainExtent.height := TVkDevice( _Device ).Devices.Instan.Surfacs[0].PxSizeY;
     ...
     begin
          ...
          pNext                 := nil;
          flags                 := 0;
          surface               := TVkDevice( _Device ).Devices.Instan.Surfacs[0].Handle;
