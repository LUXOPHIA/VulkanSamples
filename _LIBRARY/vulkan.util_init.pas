...
begin
     ...
     SetLength( Vulkan_.Info.framebuffers, Vulkan_.Instans[0].Devices[0].Swapchs[0].Viewers.Count );

     for i := 0 to Vulkan_.Instans[0].Devices[0].Swapchs[0].Viewers.Count-1 do
     begin
          attachments[0] := Vulkan_.Instans[0].Devices[0].Swapchs[0].Viewers[i].Handle;
...
var
   i :T_uint32_t;
begin
     for i := 0 to Vulkan_.Instans[0].Devices[0].Swapchs[0].Viewers.Count-1 do vkDestroyFramebuffer( Vulkan_.Instans[0].Devices[0].Handle, Vulkan_.Info.framebuffers[i], nil );
