...
begin
     ...
     vkCmdSetViewport( Vulkan_.Instans[0].Devices[0].Pooler.Comman.Handle, 0, NUM_VIEWPORTS, @Vulkan_.Info.viewport );
end;
...
begin
     ...
     vkCmdSetScissor( Vulkan_.Instans[0].Devices[0].Pooler.Comman.Handle, 0, NUM_SCISSORS, @Vulkan_.Info.scissor );
end;
...
begin
     ...
     Vulkan_.Instans[0].Devices[0].Pooler.Comman.EndRecord;
     cmd_bufs[0] := Vulkan_.Instans[0].Devices[0].Pooler.Comman.Handle;
     fenceInfo.sType := VK_STRUCTURE_TYPE_FENCE_CREATE_INFO;
     fenceInfo.pNext := nil;
     fenceInfo.flags := 0;
     ...
     res := vkResetCommandBuffer( Vulkan_.Instans[0].Devices[0].Pooler.Comman.Handle, 0 );
     Assert( res = VK_SUCCESS );
     Vulkan_.Instans[0].Devices[0].Pooler.Comman.BeginRecord;
     ...
     begin
          ...
          vkCmdCopyBufferToImage( Vulkan_.Instans[0].Devices[0].Pooler.Comman.Handle, texObj_.buffer, texObj_.image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, @copy_region );
