...
{ https://github.com/LunarG/VulkanSamples/tree/master/API-Samples/draw_textured_cube }
...
begin
     ...
     __draw_cube_vert.LoadFromFile( '../../_DATA/draw_textured_cube.vert' );
     __draw_cube_frag.LoadFromFile( '../../_DATA/draw_textured_cube.frag' );
     ...
     init_vertex_buffer( info, @g_vb_texture_Data[0], SizeOf( T_VertexUV ) * Length( g_vb_texture_Data ), SizeOf( T_VertexUV ), True );
     ...
     wait_seconds( 1 );
     (* VULKAN_KEY_END *)
     if info.save_images then write_ppm( info, 'draw_textured_cube' );
end;
